...
// Assuming you have a user ID and a user message
        String userId = "123"; // Replace with the actual user ID
        String userMessage = URLEncoder.encode(userMsgEdt.getText().toString(), "UTF-8"); // Encode user message

// Constructing the API URL
        String url = "http://api.brainshop.ai/get?bid=180155&key=M4YNHPsEfHYOWmRl&uid=" + userId + "&msg=" + userMessage;
